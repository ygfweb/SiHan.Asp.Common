...
namespace SiHan.Asp.Common.Extensions
{
    ...
    public static class HttpRequestExtensions
    {
        ...
        {
            // https://stackoverflow.com/questions/13086856/mobile-device-detection-in-asp-net/13086894#13086894
            string userAgent = request.GetUserAgent();
            if (userAgent.Length <4)
            {
                return false;
            }
            else if(MobileCheck.IsMatch(userAgent) || MobileVersionCheck.IsMatch(userAgent.Substring(0, 4)))
            {
                return true;
            }
            else
